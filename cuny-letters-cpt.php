        ...
        add_action('admin_menu', function() {
            add_menu_page(
                ...
                function() {
                    ...
                    echo '<tr><th><label for="cpt_slug">' . esc_html__('Slug', 'cuny-letters-cpt') . '</label></th><td><input name="cpt_slug" id="cpt_slug" type="text" required></td></tr>';
                    echo '<tr><th><label for="cpt_singular">' . esc_html__('Singular Name', 'cuny-letters-cpt') . '</label></th><td><input name="cpt_singular" id="cpt_singular" type="text" required></td></tr>';
                    echo '<tr><th><label for="cpt_plural">' . esc_html__('Plural Name', 'cuny-letters-cpt') . '</label></th><td><input name="cpt_plural" id="cpt_plural" type="text" required></td></tr>';
                    echo '</table>';
